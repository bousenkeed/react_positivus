...
function Navigation({ links }) {
    return (
        <div className={styles.footer__navigation}>
            <a className={styles.footer__navigation__logo} href="/">
                <img src="images/logo-white.svg" alt="Logo Positivus" />
            </a>
            <nav className={styles.footer__navigation__list}>
            ...
            <div className={styles.footer__navigation__social}>
                <a href="/">
                    <svg
                        width="30"
                        height="30"
