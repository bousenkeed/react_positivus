...
function ServicesCard({ title1, title2, image, variant = 'grey' }) {
    // variant = 'grey', 'green', 'dark'
    return (
        <li className={`${styles.ServicesCard} ${styles[variant]}`}>
            <div className={styles.ServicesCard__body}>
                <h3 className={styles.ServicesCard__title}>
                    <span className={styles[variant]}>{title1}</span>
                    <span className={styles[variant]}>{title2}</span>
                </h3>
                <a className={styles.ServicesCard__link} href="/">
                    ...
                    <span className={styles[variant]}>Learn more</span>
                </a>
            </div>

            <div className={styles.ServicesCard__image}>
                <img src={image} alt="Services card" />
            </div>
        </li>
    );
}
